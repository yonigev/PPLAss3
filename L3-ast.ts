...
export interface LazyVarDecl {tag: "LazyVarDecl"; var:string};
export interface AppExp {tag: "AppExp"; rator: CExp; rands: CExp[]; };
// L2
export interface IfExp {tag: "IfExp"; test: CExp; then: CExp; alt: CExp; };
export interface ProcExp {tag: "ProcExp"; args: (VarDecl | LazyVarDecl)[], body: CExp[]; };
...
export const makeLazyVarDecl = (v: string): LazyVarDecl => ({tag: "LazyVarDecl", var: v});
...
export const makeProcExp = (args: (VarDecl | LazyVarDecl)[], body: CExp[]): ProcExp =>
